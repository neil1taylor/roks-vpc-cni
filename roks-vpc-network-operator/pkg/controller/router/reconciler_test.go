...
func TestBuildRouterPod_NoNAT(t *testing.T) {
	...
	pod := buildRouterPod(router, gw, nil, nil)
...
func TestPodNeedsRecreation_IDSAdded(t *testing.T) {
	...
	existingPod := buildRouterPod(oldRouter, gw, nil, nil)
	...
	r := &Reconciler{}
	if !r.podNeedsRecreation(existingPod, newRouter, gw, nil, nil) {
...
func TestBuildInitScript_PerNetworkDHCP(t *testing.T) {
	...
	script := buildInitScript(router, gw, nil, nil)
...
func TestBuildRouterPod_DHCPConfigHash(t *testing.T) {
	...
	pod1 := buildRouterPod(router1, gw, nil, nil)
	pod2 := buildRouterPod(router2, gw, nil, nil)
...
func TestPodNeedsRecreation_NoPodSpecChanges(t *testing.T) {
	...
	existingPod := buildRouterPod(router, gw, nil, nil)

	r := &Reconciler{}
	if r.podNeedsRecreation(existingPod, router, gw, nil, nil) {
